...
export function Stats() {
  return (
    <section id="stats" className="relative overflow-hidden bg-dark-alt py-20 sm:py-24">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(26,102,224,0.2),transparent_60%)]" />
      <div className="site-shell relative">
        <MotionDiv className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-light">Trust</p>
...
function Counter({ value, suffix }: { value: number; suffix: string }) {
  ...
  return (
    <p ref={ref} className="text-4xl font-black tracking-tight text-white sm:text-5xl">
      <span className="bg-gradient-to-r from-brand-light via-white to-brand bg-clip-text text-transparent">
        {count}
        {suffix}
      </span>
    </p>
